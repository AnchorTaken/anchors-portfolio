                    ...
                    <span className="url-address flex">
                      {tabs.map((tab, index) => {
                        return (
                          ...
                          >
                            {" "}
                            anchor:// <span>{tab.attributes.name}</span>
                            .js
                          </span>
                        );
                      })}
                      ...
                      <div
                        ...
                        className={
                          tabsActive == currentTab
                            ? "single absolute flex w-full z-10"
                            : "single absolute flex w-full"
                        }
                      >
                        {" "}
                        <div
                        ...
                        >
                          ...
                          >
                            ...
                            {code === true ? (
                              <div className="inner">
                                <i className="gg-code-slash"></i>Switch to code
                              </div>
                            ) : (
                              <div className="inner">
                                <i className="gg-browse"></i>Swtich to text
                              </div>
                            )}{" "}
                          </button>
                          <div
                          ...
                          >
                            ...
                            >
                              ...
                              <span className="cyan titlez"> Information</span>{" "}
                            ...
                            >
                              <span className="pink code">export default</span>{" "}
                            ...
                            <div className="bdy">
                              ...
                              >
                                ...
                                <span className="softblue code">info</span>{" "}
                                <span className="code">=</span>
